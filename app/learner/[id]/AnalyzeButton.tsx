...
export default function AnalyzeButton({
  ...
  async function runAnalysis() {
    ...
    try {
      ...
      // Voyage is the only post-analysis page now. Refreshing the current
      // route works because both the voyage page and the assess-redirect
      // path land here after analysis.
      router.refresh()
    } catch (err) {
