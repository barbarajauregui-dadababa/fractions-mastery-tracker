...
const SANDBOX_PROBLEMS: BuildFractionProblem[] = [
  {
    ...
    framing_text: 'Build three-fourths of this bar. Drag pieces into the bar until it shows 3/4 filled.',
  },
  {
    id: 'sandbox-2',
    problem_type: 'build_fraction',
    ...
    framing_text: 'Build two-thirds. You can use any pieces that add up to 2/3.',
  },
  {
    id: 'sandbox-3',
    problem_type: 'build_fraction',
    target_shape: 'bar',
    goal: { numerator: 5, denominator: 6 },
    available_denominators: [2, 3, 6, 12],
    framing_text: 'Build five-sixths.',
  },
  {
    id: 'sandbox-4',
    problem_type: 'build_fraction',
